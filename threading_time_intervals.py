...
# Make sure train_model_intervals.py is in the same directory or update the path accordingly
try:
    from train_model_intervals import train_model
except ModuleNotFoundError:
    raise ImportError("train_model_intervals.py not found. Please ensure it exists in the same directory as this script.")
